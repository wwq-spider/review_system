	...
	<div id="maincontent">
		...
		<div class="tikuselectwrap">
			<c:forEach items="${resultMap}" var="item">
				...
				<table cellpadding="3" cellspacing="0" style="width: 60%; margin:auto; margin-top: 10%; margin-bottom: 4%;">
					<tbody>
				<c:forEach items="${item.value}" var="reviewType">
					<tr style="font-size: 17px;">
						...
						<td style="text-align: start; padding: 10px;">
							<c:choose>
								<c:when test="${reviewType.reviewTimes > 0}"><span style="color: #70c677">已完成</span></c:when>
