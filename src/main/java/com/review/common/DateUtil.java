...
*/
    ...
    public static Date strToDate(String strDate) {
    	Date date = null;
    	try {
    		date = new SimpleDateFormat(simpleDateFormat1).parse(strDate);
     ...
     * @return
     */
    public static Date getNextYearFianllyDay() {
    	String nowStr = getCurrentDateStr();
    	int year = Integer.parseInt(nowStr.split("-")[0]);
    	String nextYear = (year+1)+"-12-31 00:00:00";
    	return stringToUtilDate(nextYear);
    }
