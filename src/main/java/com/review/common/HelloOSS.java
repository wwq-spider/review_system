...
public class HelloOSS {
    ...
    private static String accessKeyId = bundle.getString("ACCESS_ID");
    private static String accessKeySecret = bundle.getString("ACCESS_KEY");

    // Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
    private static String bucketName = "xztx-review-img";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            InputStream is = new FileInputStream("/Users/bytedance/Downloads/picMadeByMatools.png");

            ossClient.putObject(bucketName, "2021-09-29/picMadeByMatools.png", is);
            System.out.println("Object：" + "picMadeByMatools.png" + "存入OSS成功。");
